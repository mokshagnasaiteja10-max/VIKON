...
export const initialProperties: Property[] = [
  ...
  {
    id: "vikon-emerald-heights",
    name: "Vikon Emerald Heights",
    ...
    description: "Located in the highly sought-after Asr Nagar area, Vikon Emerald Heights is a premium residential community. The project is constructed using deep bored pile foundations to ensure solid safety against local soft-clay soil conditions. Featuring modern amenities and elegant layout styling.",
...
export const initialTestimonials: Testimonial[] = [
  {
    ...
    quote: "I purchased a 3 BHK flat in Sri Sai Ram Residency. The construction quality is exemplary. Unlike other builders who compromise on steel and sand, Vikon Constructions provides proper certificates and allowed us to inspect concrete mixing at every stage. Fully Vaastu compliant too!",
    rating: 5,
  ...
  },
  {
    ...
    quote: "We partnered with Vikon Constructions for a joint venture on our 800 sq. yards land in Asr Nagar. Their transparent agreement, dedication to using pile foundations due to soft soil, and prompt share distribution made the entire process stress-free. Highly recommended!",
    rating: 5,
